...
class Composite < Component
  ...
  def operation
    result = []
    @children.each{ |children| result.append(children.operation) }
    "Branch(#{result.join('+')})"
  end 
end 
...
puts 'Client: Now i have got a composite tree'
client_code(tree)
puts "\n"

puts "Client: i dont need to check the component classes even when managing the tree:"
